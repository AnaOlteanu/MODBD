...
public class Discount {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sec_discount_global")
    @SequenceGenerator(name = "sec_discount_global", sequenceName = "sec_discount_global", initialValue = 1002, allocationSize = 1)
