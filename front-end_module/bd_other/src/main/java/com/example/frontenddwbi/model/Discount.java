...
public class Discount {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sec_discount_other")
    @SequenceGenerator(name = "sec_discount_other", sequenceName = "sec_discount_other", initialValue = 1001, allocationSize = 1)
