...
public class Hotel {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sec_hotel_other")
    @SequenceGenerator(name = "sec_hotel_other", sequenceName = "sec_hotel_other", initialValue = 1001, allocationSize = 1)
